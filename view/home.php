        ...
        <div class="row">
          ...
          <a href="index.php?act=za"> <input type="submit" value="Z-A " name="za"></a>
            <div class="boxsp">
                    ...
                    <center>
                        ...
                        <div class="row">
                            <form action="index.php?act=addtocart" method="post">
                                ...
                                <input type="submit" value="Thêm Vào Giỏ Hàng " name="addtocart1" id="btn1">
                            </form>
                        </div>
                    </div>
                ...
                <!-- <div class="sp mr">
                    <img src="./img/ip2.jpg" alt="">
                    <p>$19.00</p>
                    <a href="">Điện thoại</a>
                </div>
                <div class="sp mr">
                    <img src="./img/pa2.jpg" alt="">
                    <p>$19.00</p>
                    <a href="">Điện thoại</a>
                </div>
                <div class="sp mr">
                ...
                <div class="sp mr">
                    <img src="./img/pa4.jpeg" alt="">
                    <p>$19.00</p>
                    <a href="">Điện thoại</a>
                </div>
                <div class="sp mr">
                    <img src="./img/pa3.jpg" alt="">
                    <p>$19.00</p>
                    <a href="">Điện thoại</a>
                </div>
                <div class="sp mr">
